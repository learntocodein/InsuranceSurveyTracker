      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          b.addEventListener("click", function(e) {
              ...
              var withNoDigits = this.getElementsByTagName("input")[0].value.replace(/[0-9]/g, '');
              inp.value = withNoDigits;
              var str = this.getElementsByTagName("input")[0].value.replace(/[^0-9\.]+/g, "");
              document.getElementById("partrate").value = str; 
...
var countries = ["Rear Bumper 5000","Rear Bumper 4000","Rear Bumper 4500","Radiator 700","Radiator 800","Radiator 900",
"Radiator 1000","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas","Bahrain","Bangladesh","Barbados",
"Belarus","Belgium",
...
/*initiate the autocomplete function on the "myInput" element, and pass along the countries array as possible autocomplete values:*/
 myFunction = autocomplete(document.getElementById("myInput"), countries);
// function myFunction(){
